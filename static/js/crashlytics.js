window.crashlytics = {
  ...
  getUser : function () {
    ...
    // 사용자 회원 정보
    let brandiId = _getCookie('brand_id')
    brandiId = brandiId !== null ? brandiId : '비회원'
    let brandiName = _getCookie('brand_name')
    brandiName = brandiName !== null ? brandiName : '비회원'
    // 사용자 브라우저 정보
    let browserName
    ...
    return { id : brandiId, name : brandiName, os : userOsInfo, browser : browserName, device : deviceInfo, uuid : uuid }
  },
